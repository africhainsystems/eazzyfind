        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="{{ route('admin.listings.save') }}" id="wizard-form" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Step 1 -->
                        <div class="form-step step-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <select name="listing_category" id="listing_category" class="form-control" required>
                                        ...
                                        @foreach ($category as $item)
                                            <option value="{{ $item->id }}" {{ old('listing_category') == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <select name="listing_provider" id="listing_provider" class="form-control" required>
                                        ...
                                        @foreach ($providers as $item)
                                            <option value="{{ $item->id }}" {{ old('listing_provider') == $item->id ? 'selected' : '' }}>{{ $item->username }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="listing_phone" name="listing_phone" value="{{ old('listing_phone') }}" required>
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <textarea name="listing_description" id="editor" cols="30" rows="5" class="form-control" required>{{ old('listing_description') }}</textarea>
                                ...
                                <div class="col-sm-6 mb-3">
                                    <label for="feature_image" style="display: block;">Featured Image <span class="text-danger">*</span> <span class="text-primary">(Prefered Size: 700x700px)</span></label>
                                    <input type="file" name="feature_image" class="dropzone" id="feature_image" required/>
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <input type="file" name="listing_banner" class="dropzone" id="listing_banner" required/>
                                    <div class="invalid-feedback">Banner is required.</div>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <select id="listing_district" class="form-control" name="listing_district" required>
                                                ...
                                                @foreach(\App\Helpers\Cities::$list as $city)
                                                    <option value="{{ $city['name'] }}" {{ old('listing_district') == $city['name'] ? 'selected' : '' }}>{{ $city['name'] }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="row" id="working-hours">
                                            <div class="col-sm-3 mb-3">
                                                <select id="weekday" class="form-control" name="weekday[]">
                                                    ...
                                                    <option value="Monday" {{ old('weekday') == 'Monday' ? 'selected' : '' }}>Monday</option>
                                                    <option value="Tuesday" {{ old('weekday') == 'Tuesday' ? 'selected' : '' }}>Tuesday</option>
                                                    <option value="Wednesday" {{ old('weekday') == 'Wednesday' ? 'selected' : '' }}>Wednesday</option>
                                                    <option value="Thursday" {{ old('weekday') == 'Thursday' ? 'selected' : '' }}>Thursday</option>
                                                    <option value="Friday" {{ old('weekday') == 'Friday' ? 'selected' : '' }}>Friday</option>
                                                    <option value="Saturday" {{ old('weekday') == 'Saturday' ? 'selected' : '' }}>Saturday</option>
                                                    <option value="Sunday" {{ old('weekday') == 'Sunday' ? 'selected' : '' }}>Sunday</option>
                                                </select>
                                            ...
                                            <div class="col-sm-3 mb-3">
                                                <input class="form-control" name="open_time[]" id="open_time" type="time" value="12:05">
                                            ...
                                            <div class="col-sm-3 mb-3">
                                                <input class="form-control" name="close_time[]" id="close_time" type="time" value="12:05">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="social-links-container">
                                        <div class="row" id="social-links-row">
                                            ...
                                            <div class="col-sm-4 mb-3">
                                                <input class="form-control" name="social_url[]" id="social_url" type="text" value="URL">
                                    ...
                                    <div class="faqs-container">
                                        <div class="row" id="faqs-row">
                                            <div class="col-sm-9 mb-3">
                                                <div class="row">
                                                    <div class="col-sm-12 mb-3">
                                                        <input type="text" name="question[]" id="question" class="form-control" placeholder="Type Question" value="{{ old('question') }}">
                                                    ...
                                                    <div class="col-sm-12 mb-3">
                                                        <textarea name="answer[]" id="answer" cols="30" rows="3" class="form-control" placeholder="Type your answer">{{ old('answer') }}</textarea>
                        ...
                        <div class="form-step step-4 d-none">
                            ...
                            <div class="row">
                                <div class="col-sm-12 mb-3">
                                    <textarea name="amenities" id="amenities" rows="3" class="form-control">{{ old('amenities') }}</textarea>
                                ...
                                <div class="col-sm-12 mb-3">
                                    <div class="row">
                                        <div class="col-sm-6 mb-3">
                                            ...
                                            <input class="form-control" type="text" value="{{ old('seo_title') }}" name="seo_title" id="seo_title" required>
                                        ...
                                        <div class="col-sm-6 mb-3">
                                            ...
                                            <input class="form-control" type="text" value="{{ old('seo_keywords') }}" name="seo_keywords" id="seo_keywords" required>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <textarea name="seo_description" id="seo_description" rows="4" class="form-control" required>{{ old('seo_description') }}</textarea>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            <label for="seo_thumbnail">Thumbnail <span class="text-danger">*</span></label>
                                            <input class="form-control" type="file" name="seo_thumbnail" id="seo_thumbnail" required>
...
@section('scripts')
    ...
    $(document).ready(function () {
        ...
        // Leaflet Geocoder (search functionality)
        ...
        // Search for location when the user types in the search field
