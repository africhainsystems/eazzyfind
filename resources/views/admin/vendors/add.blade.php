...
@section('body')
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.vendors.save') }}" method="post" enctype="multipart/form-data">
            @csrf
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" name="names" id="names" class="form-control" required value="{{ old('names') }}">
                                @error('names')
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" name="companyname" id="companyname" class="form-control" required value="{{ old('companyname') }}">
                                @error('companyname')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <select name="country" id="country" class="form-select" required>
                                    ...
                                    @foreach(\App\Helpers\Countries::$list as $country)
                                        <option value="{{ $country['code'] }}" {{ $country['code'] == 'UG' ? 'selected' : '' }} {{ old('country') == $country['code'] ? 'selected' : '' }}>{{ $country['name'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-lg-6 mb-3">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <select name="id_type" id="id_type" class="form-select" required>
                                    ...
                                    @foreach ($identity as $item)
                                        <option value="{{ $item->id }}" {{ old('id_type') == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-lg-6 mb-3">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <textarea name="details" rows="7" class="form-control">{{ old('details') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
