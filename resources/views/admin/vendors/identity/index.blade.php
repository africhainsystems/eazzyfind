...
@section('body')
    ...
    {{-- Add Model --}}
    @include('admin.vendors.identity.models.add')
    {{-- Edit Model --}}
    @include('admin.vendors.identity.models.edit')
    {{-- Delete --}}
    @include('admin.vendors.identity.models.delete')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#customTable').on('click', '.edit-data', function(){
                var id = $(this).data('id');
                $.ajax({
                    url: '/admin/identityform/'+id+'/details',
                    type: 'GET',
                    dataType: 'json',
                    success: function(response){
            ...
            $('#customTable').on('click', '.toggle-status', function(){
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "/admin/identityform/changeStatus",
                    data: {'id' : dept_id},
